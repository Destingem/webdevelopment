   ...
   if(!mobile){
    return(
        <Card color="#e9f8fa" shadow="xl" sx={{display: "flex", textAlign: "left", height: "100%", backgroundColor: "#e9f8fa"}}>
           <div style={{display: "flex", alignItems: "center", justifyContent: "center", minWidth: "10%"}}> <Text component="p"  color="#22b8cf" align="center" weight={700} size={"2rem"}>{i}.</Text></div>
            <div style={{marginLeft: "2vw"}}>
                <Text component="h3"  size={"1.5rem"} weight={700}>{heading}</Text>
                <Text component="p"  size={"1rem"} weight={400}>{text}</Text>
            </div>
        </Card>
    )
   } else {
    return(
        <Card color="#e9f8fa" shadow="xl" sx={{display: "flex", textAlign: "left", height: "100%", backgroundColor: "#e9f8fa"}}>
            ...
            <div style={{marginLeft: "2vw"}}>
            <Text component="h3"  sx={{}} color="#22b8cf" align="center" weight={700} size={"1.5rem"}>{i}. <Text component="span" size={"5vw"} weight={700}>{heading}</Text></Text>
...
export default function DevFlow({mobile}){
...
Plánování a implementace vylepšení na základě zpětné vazby"  />
         ...
         {!mobile &&   <div  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={{ width: "15vw", minWidth: "15vw", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column"}}>
           <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
                       ...
                       <Text component="h3"  color="#22b8cf" weight={700} size={"1.75rem"} style={{ position: "absolute", left: "-120%", opacity: hovered ? 1 : 0, whiteSpace: "nowrap", transition: "opacity 0.5s ease-in-out" }}>Více o vývoji</Text>
                   </div>
           </div>}
       </div>
       {!mobile && <XArrow
